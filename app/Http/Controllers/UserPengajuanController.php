...
class UserPengajuanController extends Controller
{
    public function storeWebsite(Request $request)
    {
        ...
        if ($request->hasFile('file_pendukung')) {
            $filePath = $request->file('file_pendukung')->store('dokumen_pengajuan/website', 'public');
        }
    ...
    public function storeEmail(Request $request)
    {
        ...
        $filePath = null;
        if ($request->hasFile('file_pendukung')) {
            $filePath = $request->file('file_pendukung')->store('dokumen_pengajuan/email', 'public');
        }
    ...
    public function storeTte(Request $request)
    {
        ...
        $filePath = null;
        if ($request->hasFile('file_pendukung')) {
            $filePath = $request->file('file_pendukung')->store('dokumen_pengajuan/tte', 'public');
        }
    ...
    public function storeCloud(Request $request)
    {
        ...
        $filePath = null;
        if ($request->hasFile('file_pendukung')) {
            $filePath = $request->file('file_pendukung')->store('dokumen_pengajuan/cloud', 'public');
        }
    ...
    public function storeBantuan(Request $request)
    {
        ...
        $filePath = null;
        if ($request->hasFile('file_pendukung')) {
            $filePath = $request->file('file_pendukung')->store('dokumen_pengajuan/bantuan', 'public');
        }
