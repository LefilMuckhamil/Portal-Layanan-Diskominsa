<section id="beranda" class="relative bg-[#071E3D] bg--to-br from-[#071E3D] to-[#1F4287] overflow-hidden pb-20 pt-10">
        <!-- Ornamen -->
        ...
        <div class="container mx-auto px-6 relative z-20 flex flex-col lg:flex-row items-center">
            ...
            <div class="w-full lg:w-1/2 text-white pr-0 lg:pr-4 mt-10">
                ...
                <div class="flex flex-wrap gap-4 mb-12">
                    ...
                    <a href="#tracking" class="border border-white/50 hover:border-white hover:bg-white/10 text-white px-6 py-3 rounded-xl font-semibold transition flex items-center gap-2">
                        Cek Tracking
                    </a>
                </div>
            </div>
            ...
            <div class="w-full lg:w-1/2 mt-16 lg:mt-0 relative z-20 animate-float">
                <div class="relative max-w-137.5 mx-auto w-full">
                    <div class="bg-black p-2 md:p-3 rounded-t-3xl border-4 border-gray-800 shadow-2xl relative z-10 mx-4 md:mx-0">
                        ...
                        <div class="bg-white rounded-lg overflow-hidden h-48 md:h-70px relative w-full flex">
                            <!-- Sidebar Dummy -->
