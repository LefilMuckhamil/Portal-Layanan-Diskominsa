...
@section('header_title', 'Manajemen Hosting')
@section('header_subtitle', 'Kelola pengajuan, verifikasi berkas, dan pantau progres penyediaan hosting & server.')

@section('content')

    <!-- Memanggil bagian Statistik -->
    @include('admin.hosting.partials.statistics')

    <!-- Memanggil bagian Tabel dan Modal -->
    @include('admin.hosting.partials.table', ['users' => $users])
