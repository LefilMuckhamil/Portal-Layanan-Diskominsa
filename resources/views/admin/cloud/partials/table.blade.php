                ...
                <div class="px-6 md:px-8 py-5 overflow-y-auto custom-scrollbar flex-1 flex flex-col">
                    <form method="POST" action="{{ route('admin.pengajuan.update', $item->id) }}" enctype="multipart/form-data" data-no-ajax onsubmit="return konfirmasiTolak(this)" class="flex-1 flex flex-col justify-between">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 items-stretch flex-1">
                            ...
                            {{-- KOLOM 1: INFORMASI PENANGGUNG JAWAB --}}
                            <div class="bg-slate-50/80 border border-slate-200/80 rounded-2xl p-4 flex flex-col justify-between h-full">
                                <div>
                                    <div class="flex items-center gap-2.5 mb-3.5">
                                        ...
                                        <h3 class="text-[13.5px] font-extrabold text-[#101828]">Informasi Penanggung Jawab</h3>
                                    </div>

                                    <div class="bg-white border border-slate-200 rounded-xl p-3.5 space-y-2.5 shadow-sm">
                                        <div>
                                            <p class="text-[9.5px] font-bold text-gray-400 uppercase tracking-wider mb-0.5">Nama Penanggung Jawab</p>
                                        ...
                                        <div>
                                            <p class="text-[9.5px] font-bold text-gray-400 uppercase tracking-wider mb-0.5">Email Aktivasi</p>
                                        ...
                                        <div class="bg-cyan-50 p-2.5 rounded-lg border border-cyan-100">
                                            <p class="text-[9px] font-bold text-cyan-600 uppercase tracking-wider mb-0.5">Kapasitas Diminta</p>
                                            <p class="text-[12.5px] font-black text-cyan-800">{{ $dataForm['kapasitas'] ?? '-' }}</p>
                                        </div>
                            ...
                            {{-- KOLOM 2: STATUS & HASIL (TEMPAT UPLOAD PDF HASIL/AKUN) --}}
                            <div class="bg-slate-50/80 border border-slate-200/80 rounded-2xl p-4 flex flex-col justify-between h-full">
                                <div>
                                    <div class="flex items-center justify-between mb-3.5">
                                        <div class="flex items-center gap-2.5">
                                            ...
                                            <h3 class="text-[13.5px] font-extrabold text-[#101828]">Status & Berkas Akses</h3>
                                        </div>
                                    ...
                                    <div class="space-y-3">
                                        ...
                                        <div>
                                            ...
                                            <textarea name="catatan" placeholder="Tuliskan catatan progres pemohon..." class="w-full bg-white border border-slate-300 rounded-xl p-3 text-[12px] text-[#101828] font-medium placeholder:text-[#98A2B3] outline-none focus:border-sky-400 resize-none h-28 shadow-sm">{{ old('catatan') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
