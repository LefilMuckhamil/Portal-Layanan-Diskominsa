                ...
                <div class="flex items-center justify-between gap-4 px-6 md:px-8 py-4 border-b border-[#E4E7EC] bg-gradient-to-r from-[#F8FAFC] to-[#F1F5F9] shrink-0">
                    <div class="flex items-center gap-3.5">
                        ...
                        <div>
                            ...
                            <h2 class="text-[17px] font-extrabold text-[#101828] leading-tight">Kelola Pengajuan Subdomain</h2>
                        </div>
                    </div>
                    <div class="flex items-center gap-3">
                        <span class="inline-flex items-center gap-1.5 text-[10.5px] font-bold text-violet-800 bg-violet-50 border border-violet-200 rounded-full px-3 py-1 shrink-0">
                                    ...
                                    <div class="bg-white border border-slate-200 rounded-xl p-3.5 space-y-2.5 shadow-sm">
                                        ...
                                        @if(!empty($filePemohon))
                                            <div class="pt-2.5 border-t border-slate-100">
                                                ...
                                                <a href="{{ route('dokumen.unduh', ['pengajuan' => $item->id, 'jenis' => 'pendukung']) }}" target="_blank" class="flex items-center justify-between p-2.5 rounded-xl border border-violet-200 bg-violet-50/50 hover:bg-violet-100/70 transition-all text-violet-900 group shadow-sm">
                                                    <div class="flex items-center gap-2.5 min-w-0">
                                                        <div class="w-7 h-7 rounded-lg bg-violet-600 text-white flex items-center justify-center text-xs shrink-0 shadow-sm">
                                                            <i class="fa-solid fa-file-pdf"></i>
                                                        </div>
                                                        <div class="min-w-0">
                                                            <p class="text-[11.5px] font-bold truncate">Surat Permohonan</p>
                                                            <p class="text-[9px] text-violet-600 font-medium">Klik untuk melihat / unduh file</p>
                                                        </div>
                                                    </div>
                                                    <i class="fa-solid fa-download text-xs text-violet-500 group-hover:text-violet-800 transition-colors mr-1"></i>
                                                </a>
                                            </div>
                                        @else
                                ...
                                <div>
                                    ...
                                    <div class="bg-white border border-slate-200 rounded-xl p-3.5 space-y-2.5 shadow-sm mb-3">
                                        <div class="bg-violet-50 p-2.5 rounded-lg border border-violet-100">
                                            <p class="text-[9px] font-bold text-violet-600 uppercase tracking-wider mb-0.5">Nama Subdomain</p>
                                            <p class="text-[12.5px] font-black text-violet-800 break-all">{{ $dataForm['domain'] ?? '-' }}</p>
                                        </div>
                                        <div>
                                            <p class="text-[9.5px] font-bold text-gray-400 uppercase tracking-wider mb-0.5">IP Address Server Tujuan</p>
                                            <p class="text-[12px] font-mono font-bold text-[#071E3D]">{{ $dataForm['ip_address'] ?? '-' }}</p>
                                        </div>
                                        <div>
                                            <p class="text-[9.5px] font-bold text-gray-400 uppercase tracking-wider mb-0.5">Nama Aplikasi / Sistem</p>
                                            <p class="text-[12px] font-bold text-[#071E3D]">{{ $dataForm['nama_aplikasi'] ?? '-' }}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="space-y-3">
                                        <div>
                                            ...
                                            <div class="bg-white border border-slate-200 rounded-xl flex items-center px-3 relative shadow-sm">
                                                <i class="fa-solid fa-bars-progress text-violet-600 text-[13px] mr-2"></i>
                                        ...
                                        <div id="hasil-upload-{{ $item->id }}" class="{{ $item->status === 'Selesai' ? '' : 'hidden' }}">
                                            ...
                                            <label for="admin-hasil-upload-{{ $item->id }}" class="group flex items-center justify-between gap-2 rounded-xl border-2 border-dashed border-[#DCE1E8] bg-white hover:border-violet-500 hover:bg-violet-50/40 transition-all px-3 py-2 cursor-pointer shadow-sm">
                                                <div class="flex items-center gap-2 min-w-0">
                                                    <div class="w-7 h-7 shrink-0 rounded-lg bg-slate-100 group-hover:bg-violet-500 group-hover:text-white flex items-center justify-center text-[#667085] transition-colors shadow-sm">
                                                        <i class="fa-solid fa-file-pdf text-[13px]"></i>
                                                    </div>
                                                    <div class="min-w-0">
                                                        <p id="admin-hasil-name-{{ $item->id }}" class="text-[11.5px] text-[#101828] font-bold group-hover:text-violet-900 truncate">
                                                ...
                                                <div class="px-2.5 py-1 bg-slate-50 border border-gray-200 rounded-lg text-[10.5px] font-bold text-gray-600 group-hover:border-violet-300 shrink-0">Browse</div>
                                        ...
                                        <div>
                                            ...
                                            <textarea name="catatan" placeholder="Tuliskan catatan progres yang akan muncul di E-Tracking pemohon..." class="w-full bg-white border border-slate-200 rounded-xl p-3 text-[12px] text-[#101828] font-medium placeholder:text-[#98A2B3] outline-none focus:border-violet-400 resize-none h-24 shadow-sm">{{ old('catatan') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="mt-3">
                                    @if($chatAktif ?? true)
                                        <div class="bg-white border border-slate-200 rounded-xl flex items-center px-3 shadow-sm">
                                            <i class="fa-regular fa-paper-plane text-violet-600 text-[13px] mr-2"></i>
