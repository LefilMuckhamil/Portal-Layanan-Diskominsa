@php
    $statistik = [
        ['title' => 'Total Pengajuan', 'count' => $total ?? 0, 'label' => 'Sub Domain', 'icon' => 'fa-eject', 'theme' => 'violet'],
        ['title' => 'Pending', 'count' => $pending ?? 0, 'label' => 'Antrian', 'icon' => 'fa-hourglass-half', 'theme' => 'amber'],
        ['title' => 'Proses', 'count' => $proses ?? 0, 'label' => 'Dikerjakan', 'icon' => 'fa-network-wired', 'theme' => 'blue'],
