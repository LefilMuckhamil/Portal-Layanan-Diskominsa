...
@section('header_title', 'Manajemen Subdomain')
@section('header_subtitle', 'Kelola pengajuan, verifikasi berkas, dan pantau progres pembuatan subdomain.')

@section('content')

    <!-- Memanggil bagian Statistik -->
    @include('admin.subdomain.partials.statistics')
