                                ...
                                <div class="mt-3.5">
                                    @if(!empty($item->file_pendukung))
                                        <a href="{{ route('dokumen.unduh', ['pengajuan' => $item->id, 'jenis' => 'pendukung']) }}" target="_blank" class="inline-flex items-center justify-center gap-2 w-full bg-[#16324F] hover:bg-[#0F2438] text-white py-2.5 rounded-xl font-bold text-[12px] transition-all shadow-sm">
                                            <i class="fa-solid fa-file-pdf"></i> Download Lampiran Bukti
                                        </a>
                                    @else
                                        <div class="text-center text-[11px] text-gray-400 italic bg-white py-2.5 rounded-xl border border-dashed border-gray-200">Tidak ada lampiran bukti</div>
                                    @endif
                                </div>
                            </div>
                                                ...
                                                <div class="flex items-center gap-2 min-w-0">
                                                    ...
                                                    <div class="min-w-0">
                                                        <p id="admin-hasil-name-{{ $item->id }}" class="text-[11.5px] text-[#101828] font-bold group-hover:text-rose-900 truncate">
                                                            {{ !empty($item->file_hasil) ? 'File Hasil Tersedia' : 'Pilih Berkas PDF Bukti' }}
                                                        </p>
