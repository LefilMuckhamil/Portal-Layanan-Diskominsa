<div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 lg:gap-6 mb-8">
    <div class="bg-white rounded-3xl p-5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-50 hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
        ...
        <p class="text-[11px] font-bold text-gray-400 uppercase tracking-wide">Total Tiket Masuk</p>
    ...
    <div class="bg-white rounded-3xl p-5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-50 hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
        ...
        <p class="text-[11px] font-bold text-gray-400 uppercase tracking-wide">Menunggu Respons</p>
        <div class="flex items-end gap-2 mt-1">
            <h3 class="text-3xl font-extrabold text-[#071E3D]">{{ $pengajuans->whereIn('status', ['Pending', 'Menunggu'])->count() }}</h3>
    ...
    <div class="bg-white rounded-3xl p-5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-50 hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
        ...
        <p class="text-[11px] font-bold text-gray-400 uppercase tracking-wide">Sedang Ditangani</p>
        <div class="flex items-end gap-2 mt-1">
            <h3 class="text-3xl font-extrabold text-[#071E3D]">{{ $pengajuans->whereIn('status', ['Proses', 'Sedang Ditangani'])->count() }}</h3>
    ...
    <div class="bg-white rounded-3xl p-5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-50 hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
        ...
        <p class="text-[11px] font-bold text-gray-400 uppercase tracking-wide">Tiket Selesai</p>
        <div class="flex items-end gap-2 mt-1">
    ...
    <div class="bg-white rounded-3xl p-5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-50 hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
        ...
        <p class="text-[11px] font-bold text-gray-400 uppercase tracking-wide">Tiket Ditolak</p>
        <div class="flex items-end gap-2 mt-1">
