<aside class="w-72 bg-[#071E3D] text-white flex flex-col h-full flex-shrink-0 transition-all duration-300 shadow-xl z-20">
    ...
    <div class="flex-1 overflow-y-auto py-6 px-4 space-y-1">
        ...
        <a href="{{ route('admin.website.index') }}" class="flex items-center gap-3 px-4 py-3 text-gray-300 hover:text-white hover:bg-white/5 rounded-xl font-medium transition-all duration-300 group hover:translate-x-1">
        ...
        <a href="{{ route('admin.reset-password.index') }}" class="flex items-center gap-3 px-4 py-3 text-gray-300 hover:text-white hover:bg-white/5 rounded-xl font-medium transition-all duration-300 group hover:translate-x-1">
