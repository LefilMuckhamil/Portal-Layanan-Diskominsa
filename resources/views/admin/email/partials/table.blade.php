                        ...
                        <div class="relative bg-white rounded-[2rem] p-8 max-w-md w-full mx-4 shadow-2xl overflow-y-auto max-h-[90vh] custom-scrollbar">
                            ...
                            <div class="space-y-4 bg-gray-50 p-5 rounded-2xl border border-gray-100">
                                ...
                                <div class="bg-cyan-50 p-3 rounded-xl border border-cyan-100">
                                    <p class="text-[10px] font-bold text-cyan-600 uppercase tracking-wider mb-0.5">Usulan Alamat Email</p>
                                    <p class="text-[14px] font-black text-cyan-700">{{ $dataForm['usulan_email'] ?? '-' }}</p>
                                </div>
                            </div>
                            <div class="mt-6">
...
<div id="modal-create" class="fixed inset-0 z-[150] hidden items-center justify-center">
    ...
    <div class="relative bg-white rounded-[1.5rem] w-full max-w-3xl mx-4 shadow-2xl overflow-hidden max-h-[95vh] flex flex-col animate-fade-in-down">
        ...
        <div class="px-6 md:px-8 py-5 overflow-y-auto custom-scrollbar">
            <form method="POST" action="{{ route('admin.pengajuan.storeEmail') }}" enctype="multipart/form-data" onsubmit="return konfirmasiTolak(this)">
                @csrf
                @if ($errors->any())
                    <div class="mb-5 rounded-xl border-2 border-[#FDA29B] bg-[#FEF3F2] p-3.5 text-[#B42318]">
                        <div class="flex items-center text-[12.5px] font-bold mb-1">
                            ...
                            <label for="admin-email-upload" class="group flex items-center justify-between gap-3 rounded-xl border-2 border-dashed border-[#DCE1E8] hover:border-sky-500 hover:bg-sky-50/40 transition-all px-4 py-2 cursor-pointer shadow-sm">
                                <div class="flex items-center gap-3 min-w-0">
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <p id="admin-email-name" class="text-[10.5px] text-[#667085] font-medium mt-0.5 truncate">Format PDF &middot; Maksimal 5MB</p>
                                    </div>
                                </div>
