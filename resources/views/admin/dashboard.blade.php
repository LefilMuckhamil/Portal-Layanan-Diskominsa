            ...
            <table class="w-full text-left border-collapse min-w-[800px]">
                ...
                <tbody class="divide-y divide-gray-50">
                    <tr class="hover:bg-cyan-50/20 transition-colors duration-200">
                        <td class="py-4 px-6 text-[13px] font-extrabold text-[#071E3D]">#REQ-001</td>
                        <td class="py-4 px-6 flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-[13px] font-bold text-[#071E3D]">Ahmad Fauzi</p>
                                <p class="text-[11px] text-gray-500 font-medium">Desa Panggong</p>
                            </div>
                        </td>
                        <td class="py-4 px-6">
                            <span class="text-[12px] font-bold text-gray-700 flex items-center gap-2">
                                <i class="fa-solid fa-laptop-code text-indigo-500 bg-indigo-50 p-1.5 rounded-md"></i> Pembuatan Web
                            </span>
                        </td>
                        <td class="py-4 px-6 text-[12px] text-gray-500 font-bold">22 Jul 2026</td>
                        <td class="py-4 px-6">
                            <div class="relative inline-block">
                                <select class="appearance-none bg-blue-50 text-blue-600 border border-blue-100 hover:bg-blue-100 hover:border-blue-200 font-extrabold text-[10px] uppercase tracking-wider py-1.5 pl-3 pr-7 rounded-lg cursor-pointer outline-none transition-all">
                        ...
                        <td class="py-4 px-6 text-right space-x-1">
                            ...
                            <button class="p-2 text-gray-400 hover:text-blue-500 transition-colors bg-white hover:bg-blue-50 rounded-lg shadow-sm border border-gray-100" title="Edit Data User"><i class="fa-solid fa-pen text-[13px]"></i></button>
                        </td>
                    </tr>
                </tbody>
            </table>
