                        ...
                        <div class="relative dk-rail-modal pl-10 flex flex-col h-full">
                            ...
                            <div class="space-y-3 flex-1 flex flex-col justify-between">
                                ...
                                <div>
                                    ...
                                    <label for="admin-hasil-upload-{{ $item->id }}" class="group flex items-center justify-between gap-2 rounded-xl border-2 border-dashed border-[#DCE1E8] hover:border-indigo-500 hover:bg-indigo-50/40 transition-all px-3 py-1.5 cursor-pointer shadow-sm">
                                        ...
                                        <div class="px-2.5 py-1 bg-white border border-gray-200 rounded-lg text-[10.5px] font-bold text-gray-600 group-hover:border-indigo-300 shrink-0">Browse</div>
...
<div id="modal-create" class="fixed inset-0 z-[150] hidden items-center justify-center">
    ...
    <div class="relative bg-white rounded-[1.5rem] w-full max-w-3xl mx-4 shadow-2xl overflow-hidden max-h-[95vh] flex flex-col animate-fade-in-down">
        ...
        <div class="px-6 md:px-8 py-5 overflow-y-auto custom-scrollbar">
            <form method="POST" action="{{ route('admin.pengajuan.storeWebsite') }}" enctype="multipart/form-data" onsubmit="return konfirmasiTolak(this)">
                @csrf
                @if ($errors->any())
                    <div class="mb-5 rounded-xl border-2 border-[#FDA29B] bg-[#FEF3F2] p-3.5 text-[#B42318]">
                        <div class="flex items-center text-[12.5px] font-bold mb-1">
