                    ...
                    <div class="relative pl-10 mb-5">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-3.5">
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <div class="bg-white border border-slate-300 rounded-xl flex items-center px-3 relative shadow-sm focus-within:border-blue-500 transition-all">
                    ...
                    <div class="relative pl-10 mb-3">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="bg-white border border-slate-300 rounded-xl flex items-center px-3 shadow-sm focus-within:border-blue-500 transition-all">
