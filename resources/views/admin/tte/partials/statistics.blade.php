<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
    <div class="bg-white rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-50 hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
        ...
        <p class="text-[12px] font-bold text-gray-400 uppercase tracking-wide">Total Pengajuan</p>
        <div class="flex items-end gap-3 mt-1">
            <h3 class="text-3xl font-extrabold text-[#071E3D]">84</h3>
            <span class="text-[12px] font-bold text-emerald-500 mb-1">Permohonan</span>
        </div>
    </div>
    ...
    <div class="bg-white rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-50 hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
        ...
        <div class="flex items-end gap-3 mt-1">
            ...
            <span class="text-[12px] font-bold text-amber-500 mb-1">Antrean</span>
        </div>
    </div>
    ...
    <div class="bg-white rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-50 hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
        ...
        <p class="text-[12px] font-bold text-gray-400 uppercase tracking-wide">Diproses BSSN</p>
        <div class="flex items-end gap-3 mt-1">
            <h3 class="text-3xl font-extrabold text-[#071E3D]">5</h3>
            <span class="text-[12px] font-bold text-blue-500 mb-1">Dokumen</span>
        </div>
    </div>
    ...
    <div class="bg-white rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-50 hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
        ...
        <p class="text-[12px] font-bold text-gray-400 uppercase tracking-wide">Sertifikat Terbit</p>
        <div class="flex items-end gap-3 mt-1">
            <h3 class="text-3xl font-extrabold text-[#071E3D]">67</h3>
            <span class="text-[12px] font-bold text-green-500 mb-1">Aktif</span>
        </div>
    </div>
</div>