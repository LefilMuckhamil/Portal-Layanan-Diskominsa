<div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 lg:gap-6">
    ...
    <div class="bg-white rounded-3xl p-5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-50 hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
        <div class="flex justify-between items-start mb-3">
            <div class="w-11 h-11 rounded-2xl bg-emerald-50 text-emerald-500 flex items-center justify-center text-lg">
        ...
        <div class="flex items-end gap-2 mt-1">
            ...
            <span class="text-[10px] font-bold text-emerald-500 mb-1">Permohonan</span>
        </div>
    </div>

    <!-- kartu nunggu antrean -->
    <div class="bg-white rounded-3xl p-5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-50 hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
        <div class="flex justify-between items-start mb-3">
    ...
    <div class="bg-white rounded-3xl p-5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-50 hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
        ...
        <p class="text-[11px] font-bold text-gray-400 uppercase tracking-wide">Diproses BSSN</p>
        <div class="flex items-end gap-2 mt-1">
            <h3 class="text-3xl font-extrabold text-[#071E3D]">{{ $proses ?? 0 }}</h3>
            <span class="text-[10px] font-bold text-blue-500 mb-1">Dokumen</span>
        </div>
    </div>
    ...
    <div class="bg-white rounded-3xl p-5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-50 hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
        ...
        <p class="text-[11px] font-bold text-gray-400 uppercase tracking-wide">Sertifikat Terbit</p>
        <div class="flex items-end gap-2 mt-1">
            <h3 class="text-3xl font-extrabold text-[#071E3D]">{{ $selesai ?? 0 }}</h3>
            <span class="text-[10px] font-bold text-green-500 mb-1">Aktif</span>
        </div>
    </div>
