...
<body class="bg-[#F1F5F9] min-h-screen flex items-center justify-center" style="font-family: 'Outfit', sans-serif;">
    <div class="text-center px-6 max-w-lg">
        ...
        <p class="mt-2 text-sm text-slate-600 font-medium">Sesi Anda telah berakhir atau halaman terlalu lama terbuka. Silakan masuk kembali untuk melanjutkan aktivitas.</p>
        <div class="mt-6 flex flex-wrap justify-center gap-3">
            <a href="{{ route('login') }}" class="inline-flex items-center gap-2 px-6 py-3 bg-[#071E3D] hover:bg-[#1F4287] text-white font-bold rounded-xl shadow-lg transition-colors">
