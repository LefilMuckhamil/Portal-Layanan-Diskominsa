...
<body class="bg-[#F1F5F9] min-h-screen flex items-center justify-center" style="font-family: 'Outfit', sans-serif;">
    <div class="text-center px-6 max-w-lg">
        <p class="text-8xl font-black text-[#071E3D] tracking-tight">404</p>
        <div class="mt-3 flex items-center justify-center">
            <i class="fa-solid fa-compass text-3xl text-cyan-600"></i>
        </div>
        <p class="mt-4 text-xl font-extrabold text-slate-800">Halaman Tidak Ditemukan</p>
        <p class="mt-2 text-sm text-slate-600 font-medium">Halaman yang Anda cari tidak ada, telah dipindahkan, atau nomor tiket tidak valid.</p>
