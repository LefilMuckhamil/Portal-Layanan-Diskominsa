...
<body class="min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-8 selection:bg-cyan-300 selection:text-[#071E3D] relative overflow-hidden">
    ...
    <div class="absolute inset-0 bg-gradient-to-br from-[#071E3D]/90 via-[#071E3D]/80 to-[#1F4287]/85 -z-10 mix-blend-multiply"></div>
    <div class="absolute inset-0 bg-[#071E3D]/40 -z-10"></div>

    <!-- KONTENER KARTU TENGAH (Efek Kaca Tipis / Glassmorphism) -->
    <div class="bg-white/90 backdrop-blur-xl w-full max-w-[540px] rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.3)] p-6 sm:p-8 relative z-10 border border-white/40">
        
        <!-- Logo & Header -->
        <div class="flex items-center gap-4 mb-6 pb-5 border-b border-gray-200/60">
            <div class="w-14 h-14 rounded-2xl bg-[#071E3D]/5 flex items-center justify-center flex-shrink-0 border border-gray-100">
        ...
        <form action="#" method="POST" class="space-y-4">
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="relative">
                        <input type="text" name="email" required value="{{ old('email') }}" placeholder="nama@email.com / NIP"
                            class="w-full bg-white/80 border border-gray-200/80 rounded-[12px] pl-10 pr-4 py-3 text-[13px] text-[#071E3D] font-medium placeholder-gray-400 focus:bg-white focus:border-cyan-500 focus:ring-2 focus:ring-cyan-100 outline-none transition-all">
            ...
            <button type="submit" class="w-full mt-2 flex items-center justify-center gap-2 bg-[#071E3D] hover:bg-[#1F4287] text-white font-bold rounded-[12px] py-3.5 text-[14px] transition-all duration-300 shadow-[0_8px_20px_rgba(7,30,61,0.25)] hover:shadow-[0_10px_25px_rgba(7,30,61,0.35)] transform hover:-translate-y-0.5">
