        ...
        <form action="{{ route('pengajuan.tte.store') }}" method="POST" enctype="multipart/form-data" class="relative z-10 space-y-6" onsubmit="disableSubmitButton(this)">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-7">
                ...
                <div class="group">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="no_hp" required placeholder="Contoh: 081234567890" class="w-full bg-white/80 backdrop-blur-sm border border-blue-100 rounded-2xl pl-11 pr-4 py-3.5 text-[14px] text-gray-700 font-medium focus:bg-white focus:border-cyan-400 focus:ring-4 focus:ring-cyan-400/10 outline-none transition-all shadow-sm">
                    </div>
                </div>
                ...
                <div class="group">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="alamat" required placeholder="Masukkan alamat lengkap" class="w-full bg-white/80 backdrop-blur-sm border border-blue-100 rounded-2xl pl-11 pr-4 py-3.5 text-[14px] text-gray-700 font-medium focus:bg-white focus:border-cyan-400 focus:ring-4 focus:ring-cyan-400/10 outline-none transition-all shadow-sm">
                    </div>
                </div>
            ...
            <div class="pt-6 mt-8 border-t border-blue-900/10 flex justify-end">
                <button type="submit" class="bg-gradient-to-r from-[#071E3D] to-[#1F4287] hover:from-[#1F4287] hover:to-[#278EA5] text-white px-10 py-4 rounded-2xl font-bold text-[15px] transition-all duration-300 shadow-[0_8px_20px_rgba(7,30,61,0.2)] hover:shadow-[0_8px_25px_rgba(7,30,61,0.3)] hover:-translate-y-0.5 w-full sm:w-auto flex items-center justify-center gap-3">
                    Kirim Pengajuan TTE <i class="fa-solid fa-paper-plane"></i>
                </button>
            </div>
        </form>
    </div>
