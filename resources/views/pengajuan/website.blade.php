            ...
            <form action="{{ route('pengajuan.website.store') }}" method="POST" enctype="multipart/form-data" onsubmit="disableSubmitButton(this)">
                ...
                <div class="relative dk-rail pl-11">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-10">
                        ...
                        <div>
                            <label class="block text-[12.5px] font-bold text-[#344054] mb-1.5">Nama Pimpinan</label>
                            <input type="text" name="data_pengajuan[nama_pimpinan]" value="{{ old('data_pengajuan.nama_pimpinan') }}" required placeholder="Masukkan nama pimpinan" class="dk-input w-full px-3.5 py-2.5 text-[13.5px] text-[#101828] font-medium placeholder:text-[#98A2B3]">
                        </div>
                    </div>
                </div>
                ...
                <div class="relative pl-11">
                    ...
                    <p class="text-[12.5px] text-[#667085] font-medium mb-6">Detail instansi dan domain website yang diajukan.</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
                        ...
                        <div>
                            ...
                            <div class="dk-input flex items-center pl-3.5 pr-1.5 py-1.5">
                                <input type="text" name="data_pengajuan[domain]" value="{{ old('data_pengajuan.domain') }}" required placeholder="namainstansi" class="flex-1 min-w-0 bg-transparent outline-none py-1 text-[13.5px] text-[#101828] font-bold placeholder:font-normal placeholder:text-[#98A2B3]">
                                <span class="text-[12px] text-[#16324F] bg-slate-100 border border-slate-200 rounded-lg px-3 py-1.5 ml-1 font-extrabold">.go.id</span>
                            </div>
                        </div>
                    </div>
