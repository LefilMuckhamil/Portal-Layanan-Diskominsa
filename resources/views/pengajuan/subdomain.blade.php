                ...
                <div class="relative dk-rail pl-11">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-10">
                        ...
                        <div>
                            ...
                            <input type="text" inputmode="numeric" maxlength="18" name="data_pengajuan[nip]" value="{{ old('data_pengajuan.nip') }}" required placeholder="Masukkan NIP" class="dk-input w-full px-3.5 py-2.5 text-[13px] text-[#101828] font-medium placeholder:text-[#98A2B3]">
                        </div>
                        <div>
                            <label class="block text-[12.5px] font-bold text-[#344054] mb-1.5">Email Dinas</label>
                            <input type="email" name="data_pengajuan[email_dinas]" value="{{ old('data_pengajuan.email_dinas') }}" required placeholder="nama@acehbaratkab.go.id" class="dk-input w-full px-3.5 py-2.5 text-[13.5px] text-[#101828] font-medium placeholder:text-[#98A2B3]">
                        </div>
                        <div>
                    ...
                    <div class="mb-2">
                        ...
                        <label for="file-upload" class="group flex items-center gap-4 rounded-xl border-2 border-dashed border-[#DCE1E8] hover:border-sky-500 hover:bg-sky-50/40 transition-all px-5 py-4 cursor-pointer shadow-sm">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <p id="file-name" class="text-[11.5px] text-[#667085] font-medium mt-0.5">Surat Permohonan &middot; Format PDF &middot; Maksimal 5MB</p>
                            </div>
